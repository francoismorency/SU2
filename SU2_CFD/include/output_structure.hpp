...
public:
   ...
   * \param[in] val_iZone - iZone index.
   */
  void WriteAverage_Parallel_ASCII(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned short val_iZone, unsigned short val_iInst);
   ...
   * \param[in] val_iZone - iZone index.
   */
  void WriteAverage_Parallel_Binary(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned short val_iZone, unsigned short val_iInst);
